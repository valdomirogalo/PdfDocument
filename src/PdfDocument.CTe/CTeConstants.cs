...
/// <summary>
/// Layout constants for DACTE (Documento Auxiliar do Conhecimento de Transporte Eletrônico) generation.
/// </summary>
internal static class CTeConstants
{
    ...
    internal const double PageWidth = 560.0;
